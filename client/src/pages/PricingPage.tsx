      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-6 text-xl text-gray-500">
            Scegli il piano più adatto alle tue esigenze. Tutti i piani
            includono l'accesso alla nostra piattaforma di visualizzazione
            geografica dei talenti.
          </p>
                    ...
                    <div className="mt-6">
                      ...
                      {isAnnual && (
                        <p className="mt-1 text-sm text-gray-500">
                          ...
                          {parseInt(tier.price.yearly.replace("€", "")) * 12}
                          €/anno)
                        </p>
                      )}
                    </div>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-gray-500">
                Absolutely! You can upgrade to a higher plan at any time. If you
                downgrade, the change will be applied at the end of your current
                billing period.
              </p>
            </div>
            <div>
              ...
              <p className="mt-2 text-gray-500">
                The 14-day free trial gives you full access to the Pro plan. No
            ...
            <div>
              ...
              <p className="mt-2 text-gray-500">
                A candidate is any profile uploaded to the system. You can
                modify, update, or remove profiles at any time without affecting
                the count.
              </p>
            </div>
            <div>
              ...
              <p className="mt-2 text-gray-500">
                Enterprise customers receive full implementation support. For
                Base and Pro plans, we offer detailed guides and email support.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-24 text-center">
          ...
          <p className="mt-4 text-lg text-gray-500">
            Il nostro team è pronto ad aiutarti a scegliere il piano giusto per
            le tue esigenze.
          </p>
          <div className="mt-8">
            <Button
