...
import { MapPin, Map, Users, BarChart, CheckCircle2 } from 'lucide-react';
...
const LandingPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>HR Talent Mapper - Visualizza e analizza la distribuzione del talento</title>
        <meta name="description" content="HR Talent Mapper è uno strumento per visualizzare geograficamente la distribuzione di candidati e analizzare le fonti di talento per il tuo team." />
      </Helmet>
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <header className="bg-white shadow-sm py-4 px-6 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="text-xl font-bold">HR Talent Mapper</span>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex items-center mb-4 md:mb-0">
                ...
                <span className="font-bold">HR Talent Mapper</span>
              </div>
              <div className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} HR Talent Mapper. Tutti i diritti riservati.
              </div>
            </div>
          </div>
        </footer>
