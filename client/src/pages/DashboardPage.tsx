...
const DashboardPage = () => {
  ...
  const filteredCandidates = candidates.filter((candidate) => {
    ...
    if (filters.skill && !candidate.skills.includes(filters.skill))
      return false;
    if (
      filters.institution &&
  ...
  return (
    <AppLayout>
      <Helmet>
        <title>Dashboard | TalentMatch.ai</title>
        <meta
          name="description"
          content="Interactive talent mapping dashboard for HR professionals to visualize candidate distribution and talent hotspots."
        />
      </Helmet>
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Interactive visualization of your talent pool and recruitment hotspots
        </p>
      </div>
